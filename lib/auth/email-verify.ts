 ...
 * the emailed link. Verified STATE stays the existing booleans; markEmailVerified
 * also stamps emailVerifiedAt. Every send invalidates the user's prior unused
 * email-verify tokens so only the newest link works.
 */
